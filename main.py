...
def Send():
    ...
    def select_file():
        global filename
        filename=askopenfilename(initialdir="../",filetypes=filetypes,title="Choose a file.")
    ...
    Button(window,text="+ select file", width=11,height=2, font ='arial 14 bold', bg='#fff', fg='#000',command=select_file).place(x=160,y=150)
    Button(window,text="SEND", width=9,height=2, font ='arial 14 bold', bg='#fff', fg='#000',command=sender).place(x=300,y=150)
...
def Receive():
    ...
    Button(main,text="Receive", width=9,height=2, font ='arial 14 bold', bg='#fff', fg='#000', command=receiver).place(x=20,y=500)
...
send = Button(root,height=80,width=80,image=send_image,bg='#f4fdfe',bd=0,command=Send)
send.place(x=50,y=100)

receive_image = PhotoImage(file="images/receive.png")
receive = Button(root,height=80,width=80,image=receive_image,bg='#f4fdfe',bd=0,command=Receive)
